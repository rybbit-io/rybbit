...
// Exact datetime windows and dimension filters deliberately aren't accepted:
// the homepage keeps using the existing raw-events fallback for those windows.
...
export const getSiteCardsLite = analyticsRoute<{
