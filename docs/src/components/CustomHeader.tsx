...
export function CustomHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      {/* <WelcomeBanner /> */}
      <nav
        className="mx-auto flex max-w-[1200px] items-center justify-between border-neutral-200 bg-white/70 px-4 py-3 backdrop-blur-md sm:mt-2 sm:rounded-xl sm:border dark:border-neutral-800 dark:bg-neutral-950/70"
        aria-label="Global"
      >
        {/* Logo */}
          ...
          <div className="flex items-center gap-x-2">
            <AppLink href="https://app.rybbit.io" target="_blank">
              <button
                ...
                className="cursor-pointer rounded-md border border-neutral-300 bg-white px-3 py-1.5 text-sm font-medium text-neutral-900 transition-colors hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400/60 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800"
              >
                {t("Login")}
              </button>
            </AppLink>
            <AppLink href="https://app.rybbit.io/signup" target="_blank">
              <button
                ...
                className="cursor-pointer rounded-md bg-emerald-600 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-emerald-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60"
              >
                {t("Sign up")}
              </button>
            </AppLink>
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-neutral-200 bg-white/80 backdrop-blur-md dark:border-neutral-800 dark:bg-neutral-950/80">
