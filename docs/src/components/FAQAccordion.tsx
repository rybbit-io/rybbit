    ...
    <div className="border-t border-neutral-200 dark:border-neutral-800">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Is Rybbit GDPR and CCPA compliant?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Rybbit vs. Google Analytics")}</AccordionTrigger>
          <AccordionContent>
            <p>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Rybbit vs. Plausible/Umami/Fathom")}</AccordionTrigger>
          <AccordionContent>
            <p>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Rybbit vs. Posthog/Mixpanel/Amplitude")}</AccordionTrigger>
          <AccordionContent>
            <p>
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Can I self-host Rybbit?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("How easy is it to set up Rybbit?")}</AccordionTrigger>
          <AccordionContent>
            <Link
              href="/docs/script"
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300"
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("What platforms does Rybbit support?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-8">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Is Rybbit open source?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-9">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Can I invite my team to my organization?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-10">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Can I share my dashboard publicly?")}</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-11">
          <AccordionTrigger className="px-0 py-5 text-left md:text-base">{t("Does Rybbit have an API?")}</AccordionTrigger>
          <AccordionContent>
