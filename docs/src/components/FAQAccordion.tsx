    ...
    <div className="-mt-4 md:-mt-5">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Is Rybbit GDPR and CCPA compliant?")}</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Rybbit vs. Google Analytics")}</AccordionTrigger>
          <AccordionContent className="px-0">
            <p>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Rybbit vs. Plausible/Umami/Fathom")}</AccordionTrigger>
          <AccordionContent className="px-0">
            <p>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Rybbit vs. Posthog/Mixpanel/Amplitude")}</AccordionTrigger>
          <AccordionContent className="px-0">
            <p>
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Can I self-host Rybbit?")}</AccordionTrigger>
          <AccordionContent className="px-0">
        ...
        <AccordionItem value="item-6">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("How easy is it to set up Rybbit?")}</AccordionTrigger>
          <AccordionContent className="px-0">
            <Link
              href="/docs/script"
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300"
        ...
        <AccordionItem value="item-7">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("What platforms does Rybbit support?")}</AccordionTrigger>
          <AccordionContent className="px-0">
        ...
        <AccordionItem value="item-8">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Is Rybbit open source?")}</AccordionTrigger>
          <AccordionContent className="px-0">
        ...
        <AccordionItem value="item-9">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Can I invite my team to my organization?")}</AccordionTrigger>
          <AccordionContent className="px-0">
        ...
        <AccordionItem value="item-10">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Can I share my dashboard publicly?")}</AccordionTrigger>
          <AccordionContent className="px-0">
        ...
        <AccordionItem value="item-11">
          <AccordionTrigger className="md:text-lg px-0 py-4 md:py-5 text-left gap-4">{t("Does Rybbit have an API?")}</AccordionTrigger>
          <AccordionContent className="px-0">
