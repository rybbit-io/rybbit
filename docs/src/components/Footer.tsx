...
const footerLinkClassName =
  "inline-flex min-h-11 items-center text-sm leading-5 text-neutral-600 transition-colors hover:text-emerald-700 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 dark:text-neutral-400 dark:hover:text-emerald-300 md:min-h-8";
              ...
              <div className="mt-8 flex items-center lg:mt-auto lg:pt-12">
                {socialLinks.map(({ label, href, icon: Icon }) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex size-11 items-center justify-center rounded-md text-neutral-500 transition-colors hover:bg-[var(--marketing-signal-soft)] hover:text-emerald-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 dark:text-neutral-400 dark:hover:text-emerald-300"
                    aria-label={label}
                  >
