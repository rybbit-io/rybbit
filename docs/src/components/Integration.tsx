...
const PlatformLogo = ({ name, icon: Icon, path }: { name: string; icon: ComponentType<IconProps>; path: string }) => {
  return (
    <Link
      href={path}
      className="flex min-h-20 items-center gap-3 bg-white px-4 text-emerald-900/75 transition-colors duration-200 hover:bg-emerald-50 hover:text-emerald-800 focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 dark:bg-neutral-950 dark:text-emerald-200/70 dark:hover:bg-emerald-950/35 dark:hover:text-emerald-300"
    >
