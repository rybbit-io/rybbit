...
export function Card({ title, description, children, className, icon: Icon }: CardProps) {
  return (
    <div
      className={cn(
        "overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5 md:p-6",
        className
      )}
    >
      <div className="flex items-center gap-2.5">
        {Icon && <Icon className="h-[18px] w-[18px] shrink-0 text-neutral-400 dark:text-neutral-500" />}
