...
export function UserSessions() {
  ...
  return (
    <Card
      ...
      icon={Users}
    >
      <div className="mt-5 flex-1 min-h-[300px] overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950/60 p-4 [mask-image:linear-gradient(to_bottom,black_72%,transparent_98%)]">
