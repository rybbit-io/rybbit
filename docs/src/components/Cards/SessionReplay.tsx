...
export function SessionReplay() {
  ...
  return (
    <Card
      ...
      icon={Film}
    >
      <div className="mt-6 overflow-hidden rounded-lg border border-neutral-200 bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden">
            ...
            {clickPosition && (
              <div
                className="absolute size-8 animate-ping rounded-full border-2 border-blue-500 motion-reduce:hidden"
                style={{
        ...
        {/* Video controls */}
        <div className="border-t border-neutral-200 bg-neutral-100 p-2.5 dark:border-neutral-800 dark:bg-neutral-900">
          <div className="flex items-center gap-3">
            {/* Play/Pause button */}
            <button
              type="button"
              onClick={() => setIsPlaying(!isPlaying)}
              className="flex size-11 items-center justify-center rounded-full bg-emerald-700 text-white transition-colors hover:bg-emerald-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
