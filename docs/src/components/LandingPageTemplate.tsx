    ...
    <>
      ...
      <section className="border-y border-neutral-200 dark:border-neutral-800">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6 py-10 md:py-12">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 items-center justify-items-center gap-x-8 gap-y-6">
            {customerLogos.map(logo => {
              const image = (
                <Image
                  ...
                  height={40}
                  className={cn(
                    "opacity-60 dark:opacity-70 hover:opacity-100 dark:hover:opacity-100 transition-opacity",
                    logo.className
                  )}
                />
              );
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className={cn("text-3xl md:text-4xl tracking-tight", displayFont.className)}>
          ...
          <div className="mt-12 md:mt-16 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-800">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200 dark:bg-neutral-800">
              {features.map(feature => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="bg-white dark:bg-neutral-950 p-5 md:p-6 transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-900/60"
                  >
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)] gap-10 lg:gap-16">
      ...
      <section className="py-16 md:py-24 overflow-hidden">
        <div className="mx-auto max-w-[1200px] px-4 md:px-6">
          ...
          <div className="mt-12 md:mt-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 h-[560px] md:h-[640px] [mask-image:linear-gradient(to_bottom,transparent,black_8%,black_92%,transparent)]">
