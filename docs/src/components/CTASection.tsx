import { CtaChartDecor } from "@/components/SignalDecor";
...
export function CTASection({
  ...
  return (
    <section className="relative overflow-hidden border-b border-emerald-900 bg-emerald-950 text-white">
      ...
      />
      <CtaChartDecor className="pointer-events-none absolute inset-x-0 bottom-0 h-24 w-full text-white md:h-32" />
