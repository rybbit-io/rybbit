...
export function GitHubStarButton() {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-2 rounded-md border border-white/20 bg-black/10 px-3 py-2 text-xs font-medium text-emerald-50 transition-colors duration-200 hover:border-white/30 hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
    >
        ...
        <span className="flex min-w-10 items-center justify-end gap-1 tabular-nums">
          ...
          {isLoading ? (
            <span className="h-3 w-7 animate-pulse rounded-sm bg-white/20 motion-reduce:animate-none" />
          ) : (
