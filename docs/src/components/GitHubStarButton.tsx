  ...
  return (
    <div className="mb-6 md:mb-8" onClick={() => trackAdEvent("github")}>
      <a
        ...
        className="inline-flex items-center gap-1 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 px-3 py-1.5 text-xs font-medium text-neutral-700 dark:text-neutral-200 backdrop-blur-sm transition-colors hover:border-neutral-300 dark:hover:border-neutral-700 hover:text-neutral-900 dark:hover:text-white"
      >
