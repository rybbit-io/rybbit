  ...
  return (
    <div className="mb-6 md:mb-8" onClick={() => trackAdEvent("github")}>
      <a
        ...
        className="inline-flex items-center gap-1 rounded-full border border-neutral-300 bg-white/70 px-3.5 py-1.5 text-xs font-medium text-neutral-700 backdrop-blur transition-colors hover:border-neutral-400 hover:text-neutral-900 dark:border-neutral-700 dark:bg-neutral-900/70 dark:text-neutral-300 dark:hover:border-neutral-500 dark:hover:text-white"
      >
