  ...
  return (
    <div className="mb-8" onClick={() => trackAdEvent("github")}>
      <a
        ...
        className="inline-flex items-center gap-2 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-3.5 py-1.5 text-xs font-medium text-neutral-700 dark:text-neutral-300 transition-colors hover:border-neutral-300 dark:hover:border-neutral-700 hover:text-neutral-900 dark:hover:text-white"
      >
        ...
        <span className="flex items-center gap-1 border-l border-neutral-200 dark:border-neutral-700 pl-2">
          <Star className="w-3 h-3 text-amber-400 fill-current" />
          {isLoading ? (
            <span className="block w-8 h-3.5 bg-neutral-200 dark:bg-neutral-700 rounded-sm animate-pulse"></span>
          ) : (
