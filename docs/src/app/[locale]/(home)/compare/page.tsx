          ...
          <div className="mx-auto grid max-w-[1200px] border-x border-neutral-200 dark:border-neutral-800 lg:grid-cols-12">
            <div className="border-b border-[var(--marketing-signal-border)] bg-[var(--marketing-signal-field)] px-5 py-12 text-[var(--marketing-signal-ink)] sm:px-8 lg:col-span-4 lg:border-b-0 lg:border-r lg:px-10 lg:py-16">
              <div className="lg:sticky lg:top-24">
                ...
                <p className="mt-5 max-w-sm text-base leading-7 text-[var(--marketing-signal-muted)]">
            ...
            {competitors.map((competitor) => (
              <Link
                ...
                className="group flex min-h-48 flex-col justify-between bg-white px-5 py-9 transition-colors hover:bg-[var(--marketing-signal-soft)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-emerald-600 dark:bg-neutral-950 sm:px-8 lg:px-10"
              >
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.12em] text-emerald-700 dark:text-emerald-400">Rybbit vs</p>
