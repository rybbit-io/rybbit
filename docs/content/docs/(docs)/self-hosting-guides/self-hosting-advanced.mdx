...
# Google Search Console integration. Create a "Web application" OAuth client in
# Google Cloud with the redirect URI https://your.domain.com/api/gsc/callback and
# enable the Search Console API. The Search Console section appears on the
# dashboard once both values are set.
