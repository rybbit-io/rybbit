...
- **Scope** — segments belong to the site they are created on. Organization-wide segments (available on every site in the organization) can be created through the [API](/docs/api/segments/create) by admins and owners
