...
window.rybbit.event("First Purchase", {
  value: orderTotal,
  customer_id: customerId,
});

// Track repeat purchases
window.rybbit.event("Repeat Purchase", {
  value: orderTotal,
  customer_id: customerId,
...
```javascript
// Add to cart
window.rybbit.event("Add to Cart", {
  product_id: productId,
  value: productPrice,
});

// Checkout started
window.rybbit.event("Checkout Started", {
...
```javascript
window.rybbit.event("Product View", {
